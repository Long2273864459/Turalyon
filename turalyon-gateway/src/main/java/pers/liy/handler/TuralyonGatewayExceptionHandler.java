 ...
 */
@Slf4j
public class TuralyonGatewayExceptionHandler extends DefaultErrorWebExceptionHandler {

    public TuralyonGatewayExceptionHandler(ErrorAttributes errorAttributes, ResourceProperties resourceProperties,
