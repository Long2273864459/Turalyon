...
import pers.liy.server.system.properties.TuralyonSwaggerProperties;
...
@Configuration
@EnableSwagger2
public class TuralyonWebConfigure {
    ...
    public Docket swaggerApi() {
        TuralyonSwaggerProperties swagger = properties.getSwagger();
     ...
     * @return
     */
    private ApiInfo apiInfo(TuralyonSwaggerProperties swagger) {
        return new ApiInfo(
                swagger.getTitle(),
     ...
     * @return
     */
    private SecurityScheme securityScheme(TuralyonSwaggerProperties swagger) {
     ...
     * @return
     */
    private SecurityContext securityContext(TuralyonSwaggerProperties swagger) {
    ...
    private AuthorizationScope[] scopes(TuralyonSwaggerProperties swagger) {
